 ...
 * <p/>
 * Purpose:
 * A class implementing the operations for MessageLibrary management.
 * <p/>
 *
 ...
 */
public class Server_MessageLibrary extends UnicastRemoteObject implements Server_MessageLibraryInterface, JSONString, Serializable {
    ...
    * Constructor1
    */
    public Server_MessageLibrary() throws RemoteException {
        this.name = "unknown";
    }
    ...
    */
    public Server_MessageLibrary(String fileName) throws RemoteException {
        try{
