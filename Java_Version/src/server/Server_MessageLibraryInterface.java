 ...
 * @license See above
 */
public interface Server_MessageLibraryInterface extends Remote {
    ...
    public String[] getMessageFromHeaders(String userName) throws RemoteException;
    ...
    public Message getMessage(String header, String userName) throws RemoteException;
    
    // deletes the message having the header (from user name - server and message date)
    public boolean deleteMessage(String header, String userName) throws RemoteException;
    
    // send clear text to RMI server.
    public boolean sendClearText(Message aMessage, String fromUser) throws RemoteException;
    
    // get all the emails that belongs to the user who requires it
    public String[] getMail(String userName) throws RemoteException;
